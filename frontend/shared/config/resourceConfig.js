  ...
  property: {
    ...
    transformers: {
      toCard: (property) => {
        ...
        // Si tiene mediaByFloor, obtener primera imagen exterior de ahí
        let modelImage = null
        ...
        const transformed = {
          ...
          // ✅ NUEVO: Preservar datos de HomeCare
          homecareStatus: property.homecareStatus || null,
          homecareBadge: property.homecareBadge || null
        }
    ...
    transformers: {
      toCard: (apartment) => {
        ...
        const transformed = {
          ...
          // ✅ NUEVO: Preservar datos de HomeCare
          homecareStatus: apartment.homecareStatus || null,
          homecareBadge: apartment.homecareBadge || null
        }
