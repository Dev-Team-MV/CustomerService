...
// @/Users/oficina/MV-CRM/CustomerService/frontend/shared/components/PropertyQuote/ResidentAsignment.jsx
...
const isHouse = Boolean(selectedBuilding?.quoteRef?.lot && selectedBuilding?.quoteRef?.model && selectedBuilding?.quoteRef?.facade)
...
if (isHouse) {
  payload = {
    ...
    selectedOptions: selectedOptions || {},  // ✅ AGREGAR
    // Remover price y basePrice - el backend los calcula
  }
        ...
        // ✅ Payload para apartments (otros proyectos)
        payload = {
          projectId: selectedProject,
          apartmentModelId: selectedApartment.apartmentModel?._id ?? selectedApartment.apartmentModel,
          floorNumber: selectedApartment.floorNumber,
