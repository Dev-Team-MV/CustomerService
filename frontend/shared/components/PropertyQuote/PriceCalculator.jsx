    ...
    >
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 2 }}>
          ...
          >
            {isPublic ? t('quote:signInToCreate', 'Sign In to Create Property') : t('quote:createProperty', 'Create Property')}
          </Button>
          ...
          >
            <Box component="span" sx={{ position: 'relative', zIndex: 1 }}>
              {isPublic ? t('quote:signInToSend', 'Sign In to Send Quote') : t('quote:generateAndSend', 'Generate & Send Quote')}
            </Box>
          </Button>
        </Box>
      </Box>
