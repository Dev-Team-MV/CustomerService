...
import {
  ExpandMore, Gavel, ArrowBack, CheckCircle
          ...
          >
            <Box
              sx={{
                ...
                width: 200,
                height: 200,
                bgcolor: theme.palette.secondary.light || `${theme.palette.secondary.main}20`,
                borderRadius: '50%',
                filter: 'blur(60px)'
              }}
            />

            <Box display="flex" alignItems="center" gap={2} mb={2} position="relative">
              <Box
                sx={{
                  width: 64,
                  height: 64,
        ...
        >
          <Paper
            ...
            sx={{
              ...
              border: `2px solid ${theme.palette.success?.main || '#8CA551'}`,
              display: 'flex',
              alignItems: 'center',
              gap: 2
            }}
          >
            <CheckCircle sx={{ fontSize: 40, color: theme.palette.success?.main || '#8CA551' }} />
            <Box>
              <Typography
                variant="body1"
                fontWeight={600}
