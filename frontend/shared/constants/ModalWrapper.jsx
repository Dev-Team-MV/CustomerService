    ...
    >
      <DialogTitle>
        <Box display="flex" alignItems="center" gap={2}>
          ...
          <Box>
            <Typography variant="h6" fontWeight={700} sx={{ color: theme.palette?.primary?.main || '#333F1F', fontFamily: '"Poppins", sans-serif' }}>
              {title}
            </Typography>
            {subtitle && (
              <Typography variant="caption" sx={{ color: theme.palette?.text?.secondary || '#706f6f', fontFamily: '"Poppins", sans-serif' }}>
                {subtitle}
              </Typography>
            )}
          </Box>
