...
export const BRAND = {
  PRIMARY: '#6A1B9A',      // Púrpura profundo
  SECONDARY: '#AB47BC',    // Púrpura medio/magenta
  ACCENT: '#FFB300',       // Ámbar
  INFO: '#9C27B0',         // Púrpura material
  WARNING: '#FF7043',      // Naranja
  SUCCESS: '#43A047',      // Verde

  // Gradientes principales
  GRADIENT: 'linear-gradient(135deg, #6A1B9A 0%, #AB47BC 100%)',
  GRADIENT_SECTION: 'linear-gradient(90deg, hsla(291, 64%, 88%, 1) 0%, hsla(291, 47%, 97%, 1) 50%, hsla(0, 0%, 96%, 1) 100%)',

  GRADIENT_SECONDARY: 'linear-gradient(135deg, #AB47BC 0%, #CE93D8 100%)',
  GRADIENT_ACCENT: 'linear-gradient(135deg, #FFB300 0%, #FFE082 100%)',
  GRADIENT_INFO: 'linear-gradient(135deg, #9C27B0 0%, #BA68C8 100%)',
  ...
  CARD_BG: '#f5f7fa',
  CARD_BORDER: '#e0e0e0',
  AVATAR_SHADOW: '0 8px 24px rgba(106, 27, 154, 0.18)',
}
...
export const markerSx = {
  ...
  fontWeight: 'bold',
  boxShadow: '0 4px 12px rgba(171, 71, 188, 0.25)',
