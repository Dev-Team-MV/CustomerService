...
const HouseCustomizer = ({ catalogConfig, selectedBuilding, onComplete, onBack, onOptionsChange }) => {
...
const handleOptionSelect = (optionId) => {
  ...
  // NUEVO: Notificar al padre sobre el cambio
  if (onOptionsChange) {
...
// @/Users/oficina/MV-CRM/CustomerService/frontend/apps/6town-houses/src/Components/quote/HouseCustomizer.jsx
// Líneas 163-220 - Actualizar el return con precio dinámico:
