  ...
  return (
    <>
      ...
      <ModalWrapper
        ...
        onClose={handleClose}
        icon={CloudUpload}
        title={selectedFacade ? t('models:editFacade', 'Edit Facade') : t('models:addFacade', 'Add New Facade')}
        subtitle={t('models:manageFacadeSubtitle', 'Manage facade images and deck options')}
        actions={
          <>
            <PrimaryButton
              variant="outlined"
      ...
      <ModalWrapper
        ...
        icon={Deck}
        title={editingDeckIndex !== null
          ? t('models:editDeck')
          : t('models:addDeckOption')}
        subtitle={t('models:deckSubtitle')}
        actions={
          <>
            <PrimaryButton
              variant="outlined"
