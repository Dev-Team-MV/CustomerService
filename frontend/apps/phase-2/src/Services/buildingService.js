// /Users/oficina/MV-CRM/CustomerService/frontend/apps/phase-2/src/Services/buildingService.js
...
const buildingService = {
  ...
  create: async (buildingData) => {
    try {
      const payload = {
        ...
        buildingFloorPolygons: buildingData.buildingFloorPolygons || [], // <--- AGREGA ESTO
  ...
  createOrReplaceFloorPlan: async (buildingId, floorPlanData) => {
    try {
      ...
      console.error('❌ Error creating/replacing floor plan:', error)
  ...
  saveAllFloorPlans: async (buildingId, floorPlansData) => {
    try {
      ...
      console.error('❌ Error saving all floor plans:', error)
  ...
  getApartmentModels: async (buildingId) => {
    try {
      const response = await api.get('/apartment-models', {
        params: { buildingId }
      })
      return response.data
    } catch (error) {
      console.error('❌ Error fetching apartment models:', error)
  ...
  createApartmentModel: async (modelData) => {
    try {
      ...
      console.error('❌ Error creating apartment model:', error)
  ...
  updateApartmentModel: async (id, modelData) => {
    try {
      ...
      console.error('❌ Error updating apartment model:', error)
  ...
  deleteApartmentModel: async (id) => {
    try {
      ...
      console.error('❌ Error deleting apartment model:', error)
