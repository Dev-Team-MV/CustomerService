    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {[
              { icon: <Bed />, value: model.bedrooms || 0, label: 'BEDS' },
              { icon: <Bathtub />, value: model.bathrooms || 0, label: 'BATHS' },
              { icon: <SquareFoot />, value: model.sqft || 0, label: 'SQFT' },
            ].map((spec, idx) => (
              <Box
                key={idx}
                sx={{
          ...
          >
            <span className="button-text">Edit Model</span>
          </Button>
        </CardContent>
      </Card>
    </motion.div>
