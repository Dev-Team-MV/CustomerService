...
//   // ✅ Calcular dimensiones responsive basado en el contenedor
//   useEffect(() => {
...
//         // Usar el ancho del contenedor como límite
//         let width = Math.min(containerWidth - 32, maxWidth) // 32px de padding
