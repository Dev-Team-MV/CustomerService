  ...
  return [
    ...
    },
    {
      ...
      renderCell: ({ row }) => {
              ...
              <Box>
                <Box display="flex" alignItems="center" gap={0.5}>
                  ...
                  <Typography variant="body2" fontWeight={700}>
                    {t('surveys.apartment', 'Apt')} {aptData.apartmentNumber || t('common.na', 'N/A')}
                  </Typography>
                </Box>
                <Typography variant="caption" color="text.secondary" sx={{ display: 'block', ml: 3 }}>
                  {buildingName} • {t('warranty.floor', 'Piso')} {aptData.floorNumber || t('common.na', 'N/A')}
                </Typography>
              </Box>
            )
          }
        ...
        // ✅ CASO 2: Es una Propiedad (Lote/Casa)
          ...
          return (
            <Box>
              <Box display="flex" alignItems="center" gap={0.5}>
                ...
                <Typography variant="body2" fontWeight={700}>
                  {t('onboarding.lot', 'Lote')} {lotNumber}
                </Typography>
              </Box>
              <Typography variant="caption" color="text.secondary" sx={{ display: 'block', ml: 3 }}>
                {modelName}
    ...
    },
    {
      ...
      renderCell: ({ row }) => (
        <Typography variant="body2" textTransform="capitalize">
          {t(`survey.types.${row.type}`, row.type)}
        </Typography>
      )
    },
    {
