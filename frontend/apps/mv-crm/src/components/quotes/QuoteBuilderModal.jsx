...
//     selectedRenderType: 'basic', // ✅ Nuevo campo para el tipo de acabado
//     selectedOptions: {},
...
//         selectedRenderType: quote.selectedRenderType || 'basic', // ✅ Cargar tipo de render
...
//       leadId: '', clientId: '', projectId: '',
//       lotId: '', modelId: '', facadeId: '', deckId: '', buildingId: '', apartmentId: '',
//       selectedRenderType: 'basic', // ✅ Resetear a básico
//       selectedOptions: {},
//       totalPrice: 0, downPayment: 0, interestRate: 5, termMonths: 120,
//       amortizationMethod: 'fixed', balloonAmount: 0, balloonMonth: 0,
//       startDate: new Date().toISOString().split('T')[0],
...
//       const selectedApt = apartments.find(a => a._id === formData.apartmentId)
//       newTotalPrice = selectedApt?.price || 0
//     }

//     setFormData(prev => ({ ...prev, totalPrice: newTotalPrice }))
//   }, [formData.lotId, formData.modelId, formData.facadeId, formData.deckId, formData.apartmentId, formData.buildingId, formData.selectedOptions, lots, models, facades, apartments, buildings, projectType, catalogConfig])
