...
const ClientTimeline = ({ activities = [] }) => {
  ...
  const getColumnName = (activity) => {
    ...
    if (typeof activity.columnId === 'object') {
      return activity.columnId.name
    }
    return null
  }
        ...
        return (
          ...
          >
            ...
            >
              ...
              <Box display="flex" gap={1} flexWrap="wrap" mb={1}>
                ...
                {activity.priority && (
                  <Chip
                    ...
                    size="small"
                    sx={{
                      bgcolor: activity.priority === 'high' ? '#ffebee' : 
                               activity.priority === 'medium' ? '#fff3e0' : '#e8f5e9',
                      color: activity.priority === 'high' ? '#c62828' : 
                             activity.priority === 'medium' ? '#f57c00' : '#2e7d32',
                      fontFamily: '"Courier New", monospace',
                      fontSize: '0.6rem',
                      fontWeight: 600,
                      height: 20,
                  ...
                  {activity.tags.map((tag, idx) => (
                    <Box
                      ...
                      sx={{
                        px: 1,
                        py: 0.3,
                        bgcolor: tag === 'automation' ? '#f3e5f5' : '#f5f5f5',
                        color: tag === 'automation' ? '#9c27b0' : '#666',
                        borderRadius: 0.5,
                        fontFamily: '"Courier New", monospace',
                        fontSize: '0.6rem',
                        letterSpacing: '0.5px',
              ...
              <Box display="flex" gap={2} alignItems="center" mt={1.5} flexWrap="wrap">
                {activity.assignedTo && (
