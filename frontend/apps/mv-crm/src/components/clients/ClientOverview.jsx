...
const ClientOverview = ({ client, properties: rawProperties }) => {
  ...
  return (
    <Box sx={{ p: { xs: 1, sm: 3 } }}>
      ...
      {/* ✅ 1. DATOS PERSONALES CON ID */}
      <Paper id="client-overview-personal" elevation={0} sx={{ p: { xs: 2, sm: 3 }, mb: 3, border: '1px solid #ececec', borderRadius: 0, bgcolor: '#fff' }}>
      ...
      {/* ✅ 2. MEMBRESÍAS DE PROYECTO CON ID */}
      {client.projectMemberships && client.projectMemberships.length > 0 && (
        <Paper id="client-overview-projects" elevation={0} sx={{ p: { xs: 2, sm: 3 }, mb: 3, border: '1px solid #ececec', borderRadius: 0, bgcolor: '#fff' }}>
          <Typography sx={{ fontFamily: '"Courier New", monospace', fontSize: '0.7rem', color: '#000000ff', letterSpacing: '1.5px', textTransform: 'uppercase', mb: 2 }}>
      ...
      {/* ✅ 3. RESUMEN FINANCIERO CON ID */}
      <Paper id="client-overview-stats" elevation={0} sx={{ p: 2, mb: 3, border: '1px solid #ececec', borderRadius: 0, bgcolor: '#fafafa', display: 'flex', flexWrap: 'wrap', justifyContent: { xs: 'space-between', sm: 'space-around' }, gap: 2 }}>
        {[
      ...
      {/* ✅ 4. LISTA DE PROPIEDADES CON ID */}
      <Box id="client-overview-properties">
        <Typography sx={{ fontFamily: '"Courier New", monospace', fontSize: '0.7rem', color: '#000000ff', letterSpacing: '1.5px', textTransform: 'uppercase', mb: 2 }}>
