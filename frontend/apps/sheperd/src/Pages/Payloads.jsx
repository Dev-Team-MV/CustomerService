...
import { Add, AccountBalance, Schedule, ErrorOutline, Cancel } from '@mui/icons-material'
...
const Payloads = () => {
  ...
  const {
    ...
    fetchResources: async () => {
      const res = await api.get('/apartments', { params: { projectId } })
      return res.data
    },
    fetchStats: async () => {
  ...
  const filteredPayloads = payloads.filter(p => !!p.apartment)
