...
export const usePayloadColumns = ({
  ...
  return [
    {
      field: 'apartment',
      headerName: t('payloads:apartment'),
      minWidth: 150,
      renderCell: ({ row }) => (
        <Box>
