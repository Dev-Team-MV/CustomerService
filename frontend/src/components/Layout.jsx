...
const Layout = ({ publicView = false }) => {
  ...
  const privateMenuItems = [
    ...
    { text: 'Club House', icon: <Deck />, path: '/clubhouse-manager', roles: ['superadmin', 'admin', 'user'] },
    ...
    { text: 'News', icon: <Article />, path: '/news', roles: ['superadmin', 'admin'] },
    { text: 'My Property', icon: <HomeIcon />, path: '/my-property', roles: ['superadmin', 'admin', 'user'] },
    { text: 'Amenities', icon: <Deck />, path: '/amenities', roles: ['superadmin', 'admin', 'user'] }
  ]
  ...
  const drawer = (
    ...
    >
      ...
      <List sx={{ flex: 1, px: 2, py: 3, overflowY: 'auto' }}>
        {/* ✅ Botón de notificaciones - NARANJA del brandbook */}
        {!publicView && user && (
              ...
              <ListItemButton
                ...
                sx={{
                  ...
                  '&::before': {
                    ...
                    width: '100%',
                    height: '100%',
                    background: 'linear-gradient(90deg, transparent, rgba(229, 134, 60, 0.1), transparent)',
              ...
              >
                <ListItemButton
                  ...
                  sx={{
                    ...
                    py: 1.8,
                    position: 'relative',
                    bgcolor: isActive ? 'rgba(140, 165, 81, 0.08)' : 'transparent',
                    ...
                    '&::before': {
                      ...
                      width: '100%',
                      height: '100%',
                      background: 'linear-gradient(90deg, transparent, rgba(140, 165, 81, 0.08), transparent)',
                      transition: 'left 0.5s ease'
                    },
                    '&::after': isActive ? {
                      content: '""',
                    ...
                    '&:hover': {
                      bgcolor: isActive ? 'rgba(140, 165, 81, 0.12)' : 'rgba(140, 165, 81, 0.06)',
                  ...
                  <ListItemIcon sx={{ minWidth: 48 }}>
                    <Box 
                      sx={{
                        ...
                        height: 40,
                        borderRadius: 2.5,
                        bgcolor: isActive ? 'rgba(140, 165, 81, 0.15)' : 'rgba(112, 111, 111, 0.05)',
      ...
      <Box sx={{ 
        ...
        background: 'linear-gradient(180deg, rgba(140, 165, 81, 0.03) 0%, transparent 100%)'
      }}>
      ...
      <AppBar
        ...
        sx={{
          ...
          '&::before': {
            ...
            right: 0,
            height: 3,
            background: 'linear-gradient(90deg, #333F1F 0%, #8CA551 50%, #333F1F 100%)',
            opacity: 0.6
          }
        }}
      >
...
sx={{
                ...
                >
                  ...
                  <Divider sx={{ my: 0.5, borderColor: 'rgba(140, 165, 81, 0.15)' }} />
